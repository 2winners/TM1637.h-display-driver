...
public:
  ...
  //! @param digit choose the digit to display the number set in number		
	void num(int digit, int number);
	
  //! @param DD select if double dot is on or off use (1) or (0)	
	void doubledot(bool DD);
  //! clears display all 4 numbers	
	void clean();
